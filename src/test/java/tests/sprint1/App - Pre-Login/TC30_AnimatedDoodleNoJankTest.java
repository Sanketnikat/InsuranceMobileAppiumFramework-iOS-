...
public class TC30_AnimatedDoodleNoJankTest extends BaseTest {

    @Test
    public void TC30_verifyAnimatedDoodleNoJank() {

        System.out.println("================================");
        System.out.println("TC30 - Animated Doodle No Jank");
        System.out.println("================================");
        ...
        Assert.assertTrue(
                ...
                "Welcome screen became unavailable while animation was running."
        );

        System.out.println("Animated doodle continued without screen interruption.");

        // Tap Login to confirm UI is still responsive
        driver.findElement(
        ...
        System.out.println(
                "SC_01_TC_030 PASSED - Animated doodle did not cause visible interruption."
        );
    }
}