...
public class TC10_DateOfBirthFieldOpensDatePickerTest extends BaseTest {
    ...
    private static final By DATE_PICKER =
            AppiumBy.iOSClassChain("**/XCUIElementTypeDatePicker");
    ...
    public void TC10_dateOfBirthFieldOpensDatePicker() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(IOSLocators.DOB_INPUT)).click();
        ...
        Assert.assertTrue(
                pickerVisible,
                "Date picker did not open for the Date of Birth / Date of Incorporation field."
        );
    }
}
